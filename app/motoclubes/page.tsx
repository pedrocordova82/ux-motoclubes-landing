...
const canonicalUrl = "https://ux.tec.br/motoclubes";

export const metadata: Metadata = {
  title: "Sites institucionais para motoclubes",
  description: "Uma solução UX Consultancy para criar sites institucionais que organizam história, sedes, eventos e identidade de motoclubes.",
